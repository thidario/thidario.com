    ...
    (s.prototype = {
        _generate: function () {
            ...
            (this.canvas = document.createElement("canvas")),
                ...
                (this.$img = t('<img src=""/>').attr("crossOrigin", "").css({ position: "absolute", width: "100%", height: "100%" })),
                (this.$scratchpad = t(this.canvas).css({ position: "absolute", width: "100%", height: "100%" })),
                this.$scratchpad.bindMobileEvents(),
                this.$scratchpad
                    .mouseenter(
                        t.proxy(function (s) {
                            if (!this.enabled) return !0;
                            (this.canvasOffset = t(this.canvas).offset()), (this.scratch = !0), this._scratchFunc(s, "Down");
                        }, this)
                    )
                    .mousemove(
                        t.proxy(function (t) {
        ...
        reset: function () {
            ...
            (this.pixels = i * e),
                this.$scratchpad.attr("width", i).attr("height", e),
                this.canvas.setAttribute("width", i * h),
                this.canvas.setAttribute("height", e * h),
                this.ctx.scale(h, h),
                (this.pixels = i * h * e * h),
                this.$img.hide(),
                ...
                this.options.fg &&
                    ("#" === this.options.fg.charAt(0)
                        ? ((this.ctx.fillStyle = this.options.fg), this.ctx.beginPath(), this.ctx.rect(0, 0, i, e), this.ctx.fill(), this.$img.show())
                        : t(new Image())
        ...
        _scratchFunc: function (t, s) {
            (t.pageX = Math.floor(t.pageX - this.canvasOffset.left)),
                (t.pageY = Math.floor(t.pageY - this.canvasOffset.top)),
                this["_scratch" + s](t),
                (this.options.realtime || "Up" === s) && this.options["scratch" + s] && this.options["scratch" + s].apply(this, [t, this._scratchPercent()]);
        },
        ...
        _scratchDown: function (t) {
            (this.ctx.globalCompositeOperation = "destination-out"),
                ...
                this.ctx.beginPath(),
                this.ctx.arc(t.pageX, t.pageY, this.options.size / 2, 0, 2 * Math.PI, !0),
                this.ctx.closePath(),
                this.ctx.fill(),
                this.ctx.beginPath(),
                this.ctx.moveTo(t.pageX, t.pageY);
        },
        ...
        (t.support.canvas = document.createElement("canvas").getContext),
        (t.fn.wScratchPad = function (i, e) {
            if ("string" == typeof i) {
                var h,
                    a = [],
                ...
                return (
                    this.each(function () {
                        (h = t.data(this, "wScratchPad")) &&
                            (h[i] ? h[i].apply(h, [e]) : void 0 !== e ? (h.options[i] && (h.options[i] = e), h[n] && h[n].apply(h, [e])) : a.push(h[n] ? h[n].apply(h, [e]) : h.options[i] ? h.options[i] : void 0));
                    }),
                    a.length ? (1 === a.length ? a[0] : a) : this
                );
            }
            return (
                (i = t.extend({}, t.fn.wScratchPad.defaults, i)),
                this.each(function () {
        ...
        (t.fn.wScratchPad.defaults = { size: 5, bg: "#cacaca", fg: "#6699ff", realtime: !0, scratchDown: null, scratchUp: null, scratchMove: null, cursor: "crosshair" }),
